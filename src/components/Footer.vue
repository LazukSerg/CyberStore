        ...
        <div class="container container-flex-column">
            <div class="footer-info container-flex-row">
                <div class="footer-cyber container-flex-row">
                    <img src="../resources/images/footer/logo.svg" style="padding-top: 0%; height: 15%">
            ...
            <div class="footer-links">
                <a href="#"><img class="footer-link-icon" src="../resources/images/footer/twitter.svg"></a>
                <a href="#"><img class="footer-link-icon" src="../resources/images/footer/facebook.svg"></a>
                <a href="#"><img class="footer-link-icon" src="../resources/images/footer/tiktok.svg"></a>
                <a href="#"><img class="footer-link-icon" src="../resources/images/footer/instagram.svg"></a>
            </div>
