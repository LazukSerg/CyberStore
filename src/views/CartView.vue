...
import plus from '../resources/images/cart/plus.svg'
import minus from '../resources/images/cart/minus.svg'
</script>
...
export default {
  ...
  methods: {
    ...
    totalPrice() {
        let total = 0;
        function multiplyPriceByCount(value, key, map) {
            total += (value.product.discount_price ? value.product.discount_price : value.product.price) * value.count
        }
        this.getProductsInCart.forEach(multiplyPriceByCount);
        return total
    },
  },
};
            ...
            <div class="cart-items container-flex-column">
                ...
                <div v-for="[index, product] in getProductsInCart" class="cart-item container-flex-row">
                    ...
                    <div class="item-counter container-flex-row">
                        ...
                        <input class="count-input" type="tel" :disabled="true" :value="product.count"></input>
